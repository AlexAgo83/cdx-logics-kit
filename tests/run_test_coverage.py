...
def main() -> int:
    ...
    cov = coverage.Coverage(
        ...
        omit=[
            ...
            "*/logics-traceability-matrix-builder/*",
            "*/logics-architecture-decision-writer/*",
            "*/logics-backlog-groomer/*",
            "*/logics-task-breakdown/*",
            "*/logics-workstream-planner/*",
            "*/logics-product-brief-writer/*",
            "*/logics-spec-writer/*",
            "*/logics-release-gatekeeper/*",
            "*/logics-hybrid-delivery-assistant/*",
            "*/logics_flow_assist_commands.py",
            "*/logics_flow_doc_commands.py",
            "*/logics_flow_main_commands.py",
            "*/logics_flow_runtime_support.py",
            "*/logics_flow_support.py",
            "*/logics_flow_support_workflow.py",
            "*/logics_flow_support_workflow_core.py",
            "*/logics_flow_support_workflow_extra.py",
            "*/logics_flow_hybrid_helpers.py",
            "*/logics_flow_hybrid_observability.py",
            "*/logics_flow_hybrid_runtime_fallbacks.py",
            "*/logics_flow_hybrid_runtime_metrics.py",
            "*/logics_flow_hybrid_core.py",
            "*/logics_flow_hybrid_transport_extra.py",
            "*/logics_flow_hybrid_transport_routing.py",
        ],
    )
