...
def cmd_new(args: argparse.Namespace) -> None:
    ...
    template_path = repo_root / "logics/skills/logics-uiux-designer/assets/templates/uiux_proposal.md"
    ...
    values = {
        ...
        "OVERVIEW": "Describe the UX problem and intended outcome.",
        "SCENARIO_1": "Primary scenario",
        "ISSUE_1": "Key UX issue to fix",
        "GOAL_1": "Primary goal",
        "NON_GOAL_1": "Out of scope",
        "SOLUTION": "Describe the proposed UX changes screen-by-screen.",
        "SCREEN_1": "Main screen",
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(
        prog="logics_uiux.py",
        description="Create UI/UX proposal specs in logics/specs using the UI/UX proposal template.",
    )
    sub = parser.add_subparsers(dest="command", required=True)

    new_parser = sub.add_parser("new", help="Create a new UI/UX proposal doc.")
