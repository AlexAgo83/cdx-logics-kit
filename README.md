...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.1.0-4C8BF5" alt="Version" />
...
```bash
python logics/skills/logics-spec-writer/scripts/logics_spec.py new --title "My first spec" --from-version 1.1.0
```
...
cd -
git add logics/skills
git commit -m "Pin Logics kit to v1.1.0"
```
